...
**Limitations:** may include non-SectorOne pools; no bin-level quote. If empty, direct user to the app.

## CLI escalation

Exact quotes and calldata → **`dlmm-integration`** + [dlmmskills](https://github.com/DoctorTangle/dlmmskills).
