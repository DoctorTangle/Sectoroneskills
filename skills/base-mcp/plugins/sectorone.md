...
> [!NOTE]
> **Canonical copy:** [skills/sectorone-dlmm/plugin.md](../../sectorone-dlmm/plugin.md). Install the skill with `npx skills add DoctorTangle/Sectoroneskills --skill sectorone-dlmm`.
