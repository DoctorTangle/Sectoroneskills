...
> [!NOTE]
> **Canonical skill:** [skills/sectorone-dlmm/SKILL.md](../sectorone-dlmm/SKILL.md). Install with `npx skills add DoctorTangle/Sectoroneskills --skill sectorone-dlmm`. This `skills/base-mcp/` tree is a legacy layout kept for compatibility; new installs should use `sectorone-dlmm`.
